...
Append this block to `docs/PROMPTS_LOG.md`, then continue:
...
3. **Execute only the user's explicit request.** Do NOT pre-emptively generate unrequested modules or assume unprompted requirements.
